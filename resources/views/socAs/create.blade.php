<x-app-layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-700 ltr:text-left rtl:text-right dark:text-gray-300" id="h3_Title">
                        {{ __('app.create') }} {{ __('Soc_as.soc_ass') }}</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="flex border-t flex-wrap items-center">
        <div class="relative flex-row flex-1 w-full max-w-full px-4 py-4">
            <form action="{{ Route('soc_ass.store') }}" method="POST">
                @csrf
                <div class="relative grid grid-cols-6 gap-6 mt-2">
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="text" name="monthly_incomes" id="monthly_incomes" :value="old('monthly_incomes')"
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="incomes_source">
                            <option value="{{ __(old('incomes_source')) }}" readonly="true" hidden="true">
                                {{ __(old('incomes_source')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="living_kind">
                            <option value="{{ __(old('living_kind')) }}" readonly="true" hidden="true">
                                {{ __(old('living_kind')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="text" name="rent" id="rent" :value="old('rent')"
                            class="mt-1 block w-full" />
                        <x-jet-input-error for="rent" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="master_name" value="{{ __('soc_as.master_name') }}" />
                        <x-jet-input type="text" name="master_name" id="master_name" :value="old('master_name')"
                            class="mt-1 block w-full" />
                        <x-jet-input-error for="master_name" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="master_phone" value="{{ __('Soc_as.master_phone') }}" />
                        <x-jet-input type="text" name="master_phone" id="master_phone" :value="old('master_phone')"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="pre_infestation">
                            <option value="{{ __(old('pre_infestation')) }}" readonly="true" hidden="true">
                                {{ __(old('pre_infestation')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="post_infestation">
                            <option value="{{ __(old('post_infestation')) }}" readonly="true" hidden="true">
                                {{ __(old('post_infestation')) }}</option>
                            <option value="Good">{{ __('Good') }}</option>
                            <option value="Bad">{{ __('Bad') }}</option>
                            <option value="Medium">{{ __('Medium') }}</option>
                        </x-select>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="other_infestation_from_family">
                            <option value="{{ __(old('other_infestation_from_family')) }}" readonly="true"
                                hidden="true">{{ __(old('other_infestation_from_family')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="date" name="infestation_date" id="infestation_date" :value="old('infestation_date')"
                            class="mt-1 block w-full" />
                        <x-jet-input-error for="infestation_date" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="disease_kind" value="{{ __('Soc_as.disease kind') }}" />
                        <x-jet-input type="text" name="disease_kind" id="disease_kind" :value="old('disease_kind')"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="traveling">
                            <option value="{{ __(old('traveling')) }}" readonly="true" hidden="true">
                                {{ __(old('traveling')) }}</option>
                            <option value="yes">{{ __('Yes') }}</option>
                            <option value="no">{{ __('No') }}</option>
                        </x-select>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="problem_rating">
                            <option value="{{ __(old('problem_rating')) }}" readonly="true" hidden="true">
                                {{ __(old('problem_rating')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="Doctor_view_of_patient">
                            <option value="{{ __(old('Doctor_view_of_patient')) }}" readonly="true" hidden="true">
                                {{ __(old('Doctor_view_of_patient')) }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-4">
                        ...
                        <x-jet-input type="text" name="sociologist_appreciations" id="sociologist_appreciations"
                            :value="old('sociologist_appreciations')" class="mt-1 block w-full" />
                    </div>
                </div>
