            ...
            <form action="{{ Route('users.update', $users->id) }}" method="POST">
                ...
                <div class="relative grid grid-cols-6 gap-6 mt-2">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <x-jet-input type="text" name="name" id="name" value="{{ $users->name }}"
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="text" name="username" id="name" value="{{ $users->username }}"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="text" name="email" id="name" value="{{ $users->email }}"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="password" name="password" value="{{ $users->password }}"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <x-select class="mt-1" name="role_id" :value="old('role_id')">
                            <option value="{{ $users->role_id }}" readonly="true" hidden="true">{{ $users->role_id }}
                            </option>
