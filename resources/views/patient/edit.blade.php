            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-700 ltr:text-left rtl:text-right dark:text-gray-300" id="h3_Title">
                        {{ __('Edit') }} {{ __('patient_s.patients') }}</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ Route('patients.update', $patients->id) }}" method="POST">
                ...
                <div class="relative grid grid-cols-6 gap-6 mt-2">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <x-jet-input type="text" name="name" id="name" value="{{ $patients->name }}"
                            class="mt-1 block w-full" />
                        <x-jet-input-error for="name" class="mt-2" />
                    </div>
                    {{-- <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="age" value="{{ __('patient_s.age') }}" />
                        <x-jet-input type="number" name="age" id="age" value="{{ $patients->age }}"
                            class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="gender">
                            <option value="{{ $patients->gender }}" readonly="true" hidden="true">
                                {{ $patients->gender }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="date" name="Birthday" id="Birthday" value="{{ $patients->Birthday }}"
                            class="mt-1 block w-full" />
                        <x-jet-input-error for="Birthday" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="nationality" value="{{ __('patient_s.nationality') }}" />
                        <x-jet-input type="text" name="nationality" id="nationality"
                            value="{{ $patients->nationality }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="nationality" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="permanent_address" value="{{ __('patient_s.permanent_address') }}" />
                        <x-jet-input type="text" name="permanent_address" id="permanent_address"
                            value="{{ $patients->permanent_address }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="permanent_address" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="temporary_address" value="{{ __('patient_s.temporary_address') }}" />
                        <x-jet-input type="text" name="temporary_address" id="temporary_address"
                            value="{{ __($patients->temporary_address) }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="temporary_address" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="phone_number" value="{{ __('patient_s.phone_number') }}" />
                        <x-jet-input type="text" name="phone_number" id="phone_number"
                            value="{{ $patients->phone_number }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="phone_number" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="file_colors" value="{{ __('patient_s.file_colors') }}" />
                        <x-select name="file_colors" class="mt-1 block w-full">
                            <option value="{{ $patients->file_colors }}" readonly="true">{{ $patients->file_colors }}
                            </option>
                    ...
                    {{-- <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="text" name="file_number" id="file_number"
                            value="{{ $patients->file_number }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="file_number" class="mt-2" />
                    </div> --}}
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="social_status" value="{{ __('patient_s.social_status') }}" />
                        <x-jet-input type="text" name="social_status" id="social_status"
                            value="{{ $patients->social_status }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="social_status" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="place_of_birth" value="{{ __('patient_s.place_of_birth') }}" />
                        <x-jet-input type="text" name="place_of_birth" id="place_of_birth"
                            value="{{ $patients->place_of_birth }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="place_of_birth" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="profession" value="{{ __('patient_s.profession') }}" />
                        <x-jet-input type="text" name="profession" id="profession"
                            value="{{ $patients->profession }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="profession" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="card_number" value="{{ __('patient_s.card_number') }}" />
                        <x-jet-input type="text" name="card_number" id="card_number"
                            value="{{ $patients->card_number }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="card_number" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="near_mosque" value="{{ __('patient_s.near_mosque') }}" />
                        <x-jet-input type="text" name="near_mosque" id="near_mosque"
                            value="{{ $patients->near_mosque }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="near_mosque" class="mt-2" />
                    </div><br>
                    <div></div><br><div></div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="previous_treatment" value="{{ __('patient_s.previous_treatment') }}" />
                        <x-jet-checkbox name="previous_treatment" id="previous_treatment"
                            value="{{ $patients->previous_treatment }}" class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="chemotherapy" value="{{ __('patient_s.chemotherapy') }}" />
                        <x-jet-checkbox name="chemotherapy" id="chemotherapy" value="{{ $patients->chemotherapy }}"
                            class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="radiotherapy" value="{{ __('patient_s.radiotherapy') }}" />
                        <x-jet-checkbox name="radiotherapy" id="radiotherapy" value="{{ $patients->radiotherapy }}"
                            class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="surgery" value="{{ __('patient_s.surgery') }}" />
                        <x-jet-checkbox name="surgery" id="surgery" value="{{ $patients->surgery }}"
                            class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="is_smokeout" value="{{ __('patient_s.is_smokeout') }}" />
                        <x-jet-checkbox name="is_smokeout" id="is_smokeout" value="{{ $patients->is_smokeout }}"
                            class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="is_khat" value="{{ __('patient_s.is_khat') }}" />
                        <x-jet-checkbox name="is_khat" id="is_khat" value="{{ $patients->is_khat }}"
                            class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="is_chwingtobaco" value="{{ __('patient_s.is_chwingtobaco') }}" />
                        <x-jet-checkbox name="is_chwingtobaco" id="is_chwingtobaco"
                            value="{{ $patients->is_chwingtobaco }}" class="block mt-3 w-7 h-7" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="site_of_tumor" value="{{ __('patient_s.site_of_tumor') }}" />
                        <x-jet-input type="text" name="site_of_tumor" id="site_of_tumor"
                            value="{{ $patients->site_of_tumor }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="site_of_tumor" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="type_of_tumor" value="{{ __('patient_s.type_of_tumor') }}" />
                        <x-jet-input type="text" name="type_of_tumor" id="type_of_tumor"
                            value="{{ $patients->type_of_tumor }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="type_of_tumor" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="doctors_name" value="{{ __('patient_s.doctors_name') }}" />
                        <x-jet-input type="text" name="doctors_name" id="doctors_name"
                            value="{{ $patients->doctors_name }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="doctors_name" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="speciality" value="{{ __('patient_s.speciality') }}" />
                        <x-jet-input type="text" name="speciality" id="speciality"
                            value="{{ $patients->speciality }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="speciality" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="reported_by" value="{{ __('patient_s.reported_by') }}" />
                        <x-jet-input type="text" name="reported_by" id="reported_by"
                            value="{{ $patients->reported_by }}" class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-select class="mt-1" name="status">
                            <option value="{{ $patients->status }}" readonly="true" hidden="true">
                                {{ $patients->status }}</option>
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        ...
                        <x-jet-input type="date" name="date_of_last_contact" id="date_of_last_contact"
                            value="{{ $patients->date_of_last_contact }}" class="mt-1 block w-full" />
                        <x-jet-input-error for="date_of_last_contact" class="mt-2" />
                    </div>
                    <div class="col-span-3 md:col-span-2 lg:col-span-1">
                        <x-jet-label for="cause_of_death" value="{{ __('patient_s.cause_of_death') }}" />
                        <x-jet-input type="text" name="cause_of_death" id="cause_of_death"
                            value="{{ $patients->cause_of_death }}" class="mt-1 block w-full" />
                    ...
                    <div class="col-span-3 md:col-span-2 lg:col-span-4">
                        ...
                        <x-jet-input type="text" name="notes_re" id="notes_re"
                            value="{{ $patients->notes_re }}" class="mt-1 block w-full" />
